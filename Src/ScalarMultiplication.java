...
/**
 * 1. Program se snaží najít dva vektory s největší skalární součin ze zadané
 * sady vektorů
 *
 * @author Štěpán Moc
...
public class ScalarMultiplication {
    ...
    public static void run() {
        ...
        while (amountOfVectors > 0) {
            ...
            if (amountOfVectors == 1) {
                System.out.println("Počet vektorů nemůže být jedna");
            } else {
              ...
              , kteří mají největší skalární součin a na [2] vloží výsledek jejich skalárního součinu*/
                ...
                resultArray = findTwoVectors(inputArray);

                /*Vypíše jednotlivé vektory a jejich skalární součin */
                printVectorsAndScalarMultiplication(resultArray, inputArray);
            }
    ...
    public static void printVectorsAndScalarMultiplication(double[] resultArray, double[][] inputArray) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            for (int j = 0; j < inputArray[0].length; j++) {
                ...
                int line = (int) resultArray[i];
                System.out.print(inputArray[line][j] + " ");
            }
            System.out.print(")");
            System.out.println("");
        }
        System.out.println("Skalární součin těchto vektorů " + resultArray[2]);
    }
}
